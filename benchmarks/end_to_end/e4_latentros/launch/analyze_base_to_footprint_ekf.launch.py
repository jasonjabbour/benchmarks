"""
Analyze: PoseWithCovarianceStamped -> Odometry
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_base_to_footprint_ekf')
    ...
    ba = BenchmarkAnalyzer('e4_base_to_footprint_ekf', hardware_device_type)

    target_chain = [
        'robotperf_benchmarks:robotperf_pose_cov_input_cb_init',
        'robotperf_benchmarks:robotperf_pose_cov_input_cb_fini',
    ...
    for metric in metrics:
        if metric == 'latency':
            ...
            print_latentros_summary(
                ...
                'e4_base_to_footprint_ekf', target_chain)
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_base_to_footprint_ekf'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_base_to_footprint_ekf.launch.py',
