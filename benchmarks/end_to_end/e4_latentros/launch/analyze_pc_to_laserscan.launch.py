"""
Analyze: PointCloud2 -> LaserScan  (pointcloud_to_laserscan)
Session : e4_pc_to_laserscan

6-tracepoint chain (kernel has msg_received_1 / msg_published_1):
  T_in      = pointcloud_input_cb_init -> msg_received_1
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_pc_to_laserscan')
    ...
    ba = BenchmarkAnalyzer('e4_pc_to_laserscan', hardware_device_type)
    ...
    for metric in metrics:
        if metric == 'latency':
            ...
            print_latentros_summary(
                ...
                'e4_pc_to_laserscan', target_chain)
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_pc_to_laserscan'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_pc_to_laserscan.launch.py',
