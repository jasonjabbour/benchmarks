"""
Analyze: Path -> Twist  (Nav2 ControllerServer — MPPI)
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_mppi_controller')
    ...
    ba = BenchmarkAnalyzer('e4_mppi_controller', hardware_device_type)

    # 6-tracepoint chain: Path in, Twist out
    target_chain = [
        'robotperf_benchmarks:robotperf_path_input_cb_init',
        'robotperf_benchmarks:robotperf_path_input_cb_fini',
        'robotperf_benchmarks:robotperf_msg_received_1',
        'robotperf_benchmarks:robotperf_msg_published_1',
        'robotperf_benchmarks:robotperf_twist_output_cb_init',
        'robotperf_benchmarks:robotperf_twist_output_cb_fini',
    ]
    ...
    for metric in metrics:
        if metric == 'latency':
            ...
            print_latentros_summary(
                ...
                'e4_mppi_controller', target_chain)
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_mppi_controller'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_mppi_controller.launch.py',
