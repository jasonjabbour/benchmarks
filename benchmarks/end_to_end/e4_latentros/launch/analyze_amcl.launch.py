"""
Analyze: LaserScan -> PoseWithCovarianceStamped  (Nav2 AMCL localization)
Session : e4_amcl
"""
import sys
import argparse
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_amcl')
    ...
    ba = BenchmarkAnalyzer('e4_amcl', hardware_device_type)
    ...
    target_chain = [
        ...
        'robotperf_benchmarks:robotperf_pose_cov_output_cb_init',
        'robotperf_benchmarks:robotperf_pose_cov_output_cb_fini',
    ]
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_amcl'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_amcl.launch.py',
