"""
Analyze: LaserScan -> OccupancyGrid  (SLAM Toolbox)
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_slam_toolbox')
    ...
    ba = BenchmarkAnalyzer('e4_slam_toolbox', hardware_device_type)

    # 6-tracepoint chain: LaserScan in, OccupancyGrid out
    target_chain = [
        ...
        'robotperf_benchmarks:robotperf_occupancy_grid_output_cb_init',
        'robotperf_benchmarks:robotperf_occupancy_grid_output_cb_fini',
    ]
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_slam_toolbox'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_slam_toolbox.launch.py',
