"""
Analyze: JointState -> Odometry  (robot_localization state estimation)
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_state_estimation')
    ...
    ba = BenchmarkAnalyzer('e4_state_estimation', hardware_device_type)

    target_chain = [
        'robotperf_benchmarks:robotperf_joint_state_input_cb_init',
        'robotperf_benchmarks:robotperf_joint_state_input_cb_fini',
        'robotperf_benchmarks:robotperf_msg_received_1',
        'robotperf_benchmarks:robotperf_msg_published_1',
        'robotperf_benchmarks:robotperf_odometry_output_cb_init',
        'robotperf_benchmarks:robotperf_odometry_output_cb_fini',
    ]
    ...
    for metric in metrics:
        if metric == 'latency':
            ...
            print_latentros_summary(
                ...
                'e4_state_estimation', target_chain)
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_state_estimation'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_state_estimation.launch.py',
