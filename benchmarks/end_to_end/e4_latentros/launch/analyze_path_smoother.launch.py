"""
Analyze: Path -> Path  (Nav2 SmootherServer)
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_path_smoother')
    ...
    ba = BenchmarkAnalyzer('e4_path_smoother', hardware_device_type)

    # 6-tracepoint chain: Path in, Path out
    target_chain = [
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_path_smoother'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_path_smoother.launch.py',
