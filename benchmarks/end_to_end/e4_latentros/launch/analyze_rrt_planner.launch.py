"""
Analyze: PoseStamped -> Path  (Nav2 PlannerServer — RRT-Connect (OMPL))
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_rrt_planner')
    ...
    ba = BenchmarkAnalyzer('e4_rrt_planner', hardware_device_type)
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_rrt_planner'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_rrt_planner.launch.py',
