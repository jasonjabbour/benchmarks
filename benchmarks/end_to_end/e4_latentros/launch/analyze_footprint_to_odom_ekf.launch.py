...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_footprint_to_odom_ekf')
    ...
    ba = BenchmarkAnalyzer('e4_footprint_to_odom_ekf', hardware_device_type)

    target_chain = [
        'robotperf_benchmarks:robotperf_odometry_input_cb_init',
        'robotperf_benchmarks:robotperf_odometry_input_cb_fini',
    ...
    for metric in metrics:
        if metric == 'latency':
            ...
            print_latentros_summary(
                ...
                'e4_footprint_to_odom_ekf', target_chain)
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_footprint_to_odom_ekf'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_footprint_to_odom_ekf.launch.py',
