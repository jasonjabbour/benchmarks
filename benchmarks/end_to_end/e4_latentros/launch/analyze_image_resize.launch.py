"""
Analyze: Image -> Resized Image  (image_resize)
...
6-tracepoint chain (kernel has msg_received_1 / msg_published_1):
  ...
  T_out     = msg_published_1 -> image_output_cb_fini
"""
import sys
import argparse
import json
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_image_resize')
    ...
    ba = BenchmarkAnalyzer('e4_image_resize', hardware_device_type)
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_image_resize'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_image_resize.launch.py',
