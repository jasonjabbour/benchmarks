"""
Analyze: LaserScan -> LaserScan  (laserscan_range_filter)
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_laserscan_range_filter')
    ...
    ba = BenchmarkAnalyzer('e4_laserscan_range_filter', hardware_device_type)
    ...
    for metric in metrics:
        if metric == 'latency':
            ...
            print_latentros_summary(
                ...
                'e4_laserscan_range_filter', target_chain)
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_laserscan_range_filter'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_laserscan_range_filter.launch.py',
