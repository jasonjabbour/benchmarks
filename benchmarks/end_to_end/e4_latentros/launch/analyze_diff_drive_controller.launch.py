"""
Analyze: Twist -> JointState  (Diff Drive Controller)
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_diff_drive_controller')
    ...
    ba = BenchmarkAnalyzer('e4_diff_drive_controller', hardware_device_type)

    # 6-tracepoint chain: Twist in, JointState out
    target_chain = [
        ...
        'robotperf_benchmarks:robotperf_joint_state_output_cb_init',
        'robotperf_benchmarks:robotperf_joint_state_output_cb_fini',
    ]
    ...
    for metric in metrics:
        if metric == 'latency':
            ...
            print_latentros_summary(
                ...
                'e4_diff_drive_controller', target_chain)
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_diff_drive_controller'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_diff_drive_controller.launch.py',
