"""
Analyze: LaserScan -> OccupancyGrid  (Nav2 local costmap)
...
def main(argv):
    ...
    parser.add_argument('--trace_path', type=str,
                        default='/root/.ros/tracing/e4_local_costmap')
    ...
    ba = BenchmarkAnalyzer('e4_local_costmap', hardware_device_type)
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'trace_path', default_value='/root/.ros/tracing/e4_local_costmap'))
    ...
    ld.add_action(ExecuteProcess(
        cmd=[
            'python3',
            'src/benchmarks/benchmarks/end_to_end/e4_latentros/launch/analyze_local_costmap.launch.py',
