...
def main(argv):
    ...
    ba = BenchmarkAnalyzer('e1_message_type', hardware_device_type)

    if hardware_device_type == 'cpu':
        # add parameters for analyzing the traces
        ## using message header id
        target_chain = [
            "robotperf_benchmarks:robotperf_msg_published_size_1",  # 0
            "robotperf_benchmarks:robotperf_msg_received_size_1",     # 1
        ]

        ba.add_target(
            {
                "name": "robotperf_benchmarks:robotperf_msg_published_size_1",
                "name_disambiguous": "robotperf_benchmarks:robotperf_msg_published_size_1",
                "colors_fg": "yellow",
        ...
        ba.add_target(
            {
                "name": "robotperf_benchmarks:robotperf_msg_received_size_1",
                "name_disambiguous": "robotperf_benchmarks:robotperf_msg_received_size_1",
                "colors_fg": "red",
